        ...
        <div class="page watermark" style="page-break-before: always;">
            <div class="back-wrapper">
                ...
                <div style="background: #ecfdf5; border: 1px solid #6ee7b7; padding: 10px; border-radius: 8px; width: 100%; text-align: left;">
                    <h3 style="color: #047857; margin: 0 0 4px 0; font-size: 11px;">🍎 Healthy Living Tip</h3>
                    <p style="margin: 0; font-size: 10px; color: #064e3b;"><strong>Stay Hydrated:</strong> Drinking enough water helps maintain body fluids.</p>
                </div>
            </div>
        </div>
