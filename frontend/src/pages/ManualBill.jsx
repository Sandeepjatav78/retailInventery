        ...
        <div className="bg-teal-50 p-5 rounded-lg border border-teal-100 flex-grow">
            ...
            <div className="flex flex-col gap-3 relative" ref={searchRef}>
                ...
                <button 
                    ...
                    className="w-full mt-2 bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 rounded-lg shadow-md transition-all transform active:scale-95"
                >
                    + Add to Bill
                </button>
            </div>
        ...
        <div className="mt-6 pt-6 border-t-2 border-dashed border-gray-200">
            <div className="flex justify-between items-end mb-4">
                ...
                <span className="text-3xl font-extrabold text-teal-700">
                    ₹{cart.reduce((a,b)=>a+b.total,0).toFixed(2)}
                </span>
            </div>
            <button 
                onClick={handleGenerateBill} 
                className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 rounded-xl shadow-lg transition-all transform active:scale-95 flex items-center justify-center gap-2"
            >
